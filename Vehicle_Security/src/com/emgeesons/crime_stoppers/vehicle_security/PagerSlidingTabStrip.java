...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = getResources().getColor(R.color.indicator);
	private int underlineColor = getResources().getColor(R.color.underline);
	private int dividerColor = getResources().getColor(R.color.divider);
	...
	private int tabTextColor = getResources().getColor(R.color.tabtxtcolor);
